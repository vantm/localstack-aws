...
- Test terraform plan and apply in the environment `dev` only
- Must use `tflocal` over `terraform`
- The project is tested on **MiniStack**
- This project is inside a git repo. Don't need define a `.gitignore`
